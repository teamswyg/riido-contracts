...
- Source refs:
  ...
  - `riido-contracts:assignment/assignment_contract/payload-fields/allow-experimental-runtime.riido.json` requires `agent.runtime.requires_experimental_opt_in`
- Downstreams:
...
- Source refs:
  ...
  - `riido-contracts:assignment/assignment_contract/payload-fields/model-id.riido.json` requires `agent.model_id`
- Downstreams:
