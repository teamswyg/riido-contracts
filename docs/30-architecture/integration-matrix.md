...
| generated FSM projection | `tools/enumgen` and `tools/fsmgen` verify Common Lisp enum/transition/pattern metadata, imported conformance profiles, Go SPI, `fsmmeta`, and README Mermaid drift | none |
