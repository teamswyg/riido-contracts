...
| --- | --- | --- |
| IR event type names and envelope shape | `internal/ir`, `docs/20-domain/ir-event-log.md` | Promote after daemon/control-plane split both need compile-time constants or fixtures. |
| Task lifecycle state and transition fixture | `internal/task`, `docs/20-domain/task-lifecycle.md` | Promote as generated fixture or enum only if server and daemon both validate it. |
