...
type manifest struct {
	...
	ExpectedProviderHealthStatus   int          `json:"expected_provider_health_status_count"`
	ExpectedProviderDiagnosticCode int          `json:"expected_provider_diagnostic_code_count"`
